...
- Name: Subscription and Billing Flow >> should show token pricing and proceed to checkout
- Location: /home/dmn/main/code/fos/fos-mono/infra/e2e-tests/subscription-flow.spec.ts:67:7
...
Call log:
  - navigating to "http://localhost:5173/", waiting until "load"
    ...
    at /home/dmn/main/code/fos/fos-mono/infra/e2e-tests/subscription-flow.spec.ts:6:16
```
