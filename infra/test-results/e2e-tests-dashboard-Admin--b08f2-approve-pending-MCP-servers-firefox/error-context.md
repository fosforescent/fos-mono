...
- Name: Admin Dashboard (for admin users) >> should approve pending MCP servers
- Location: /home/dmn/main/code/fos/fos-mono/infra/e2e-tests/dashboard.spec.ts:287:7
...
Call log:
  - navigating to "http://localhost:5173/", waiting until "load"
    ...
    at /home/dmn/main/code/fos/fos-mono/infra/e2e-tests/dashboard.spec.ts:268:16
```
