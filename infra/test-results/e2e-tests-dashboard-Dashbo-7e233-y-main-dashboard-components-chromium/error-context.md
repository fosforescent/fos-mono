...
- Name: Dashboard Navigation and Core Features >> should display main dashboard components
- Location: /home/dmn/main/code/fos/fos-mono/infra/e2e-tests/dashboard.spec.ts:9:7
