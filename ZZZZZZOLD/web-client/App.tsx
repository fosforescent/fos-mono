...
import { DataState, defaultTrellisData } from './components/data-state'
import { TrellisRowsComponentProps } from '@/react-trellis'
...
function AppInner({
  ...
  const setDataWithLog = (data: { fosData: FosContextData, trellisData: TrellisSerializedData }) => {
...
const TopButtons = () => {
  ...
  // useTraceUpdate({ apiDataState, loggedIn, theme, promptGPT, canPromptGPT, toast, setApiDataState, fosData, setFosData, redo, undo, canRedo, canUndo, syncAndStore, data })
