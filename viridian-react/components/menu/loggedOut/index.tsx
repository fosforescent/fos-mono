  ...
  return (
    <Tabs value={tab} onValueChange={onTabChange} className="w-full">
      ...
      <TabsContent value="login">
        <LoginComponent setMessage={setMessage} setForgot={handleForgot} />
      </TabsContent>
      <TabsContent value="register">
        <RegisterComponent setMessage={setMessage} setShowTerms={setShowTerms} setShowPrivacy={setShowPrivacy}/>
      </TabsContent>
      {forgot && <TabsContent value="forgot">
            <ForgotPwdComponent setMessage={setMessage} />
      </TabsContent>}
      {passwordResetToken && <TabsContent value="reset">
        <PwdResetComponent setMessage={setMessage} passwordResetToken={passwordResetToken} /> 
      </TabsContent>}
      </Card>
    </Tabs>
  )
