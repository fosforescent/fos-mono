...
const HamburgerMenu = ({
  ...
  const { appState, sendMessage } = useAppState()
              ...
              <AccordionItem value="about">
                ...
                <AccordionContent>
                  ...
                  <div>
                    ...
                    <Button variant="link" onClick={() => setShowTerms({ open: true, fromRegisterForm: false, setAcceptTerms: (accept: boolean) => {}})}>Terms of Service</Button><br/>
