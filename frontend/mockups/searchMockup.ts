...
export const searchMockupContextStart: FosContextData = addToMockContext(["WORKFLOW", "task2"], 
  {
    // Task 2
    task2: {
      data: {
  ...
  export const searchMockupContextEnd: FosContextData = addToMockContext(["WORKFLOW", "task2"], 
    {
