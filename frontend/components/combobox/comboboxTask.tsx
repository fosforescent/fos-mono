...
import { StepButton, } from "@/frontend/components/ui/button-step"
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
import { FosDataContent, FosNodeContent, FosNodesData } from "@/frontend/types"
      ...
      <div style={{
        ...
        <Textarea
            ...
            value={currentItem
              ...
              onFocus={(e: React.FocusEvent<HTMLTextAreaElement>) => { console.log("here") ; e.stopPropagation()}}
              onClick={(e: React.MouseEvent<HTMLTextAreaElement>) => { console.log("here") ; e.stopPropagation()}}
              onKeyDown={keyDown}
              onKeyUp={keyPresses}
              />
