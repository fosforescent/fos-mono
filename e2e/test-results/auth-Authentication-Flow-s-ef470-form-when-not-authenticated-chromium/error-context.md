...
- Name: Authentication Flow >> should display login form when not authenticated
- Location: /home/dmn/main/code/fos/fos-mono/e2e/auth.spec.ts:8:7
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Fosforescent', exact: true })
    ...
    at /home/dmn/main/code/fos/fos-mono/e2e/auth.spec.ts:12:84
```
